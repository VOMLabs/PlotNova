...
dependencies {
    api(projects.plotnovaCore)

    // Metrics
    implementation(libs.faststatsBukkit)
...
tasks.named<ShadowJar>("shadowJar") {
    dependsOn(":plotnova-core:shadowJar")
    dependencies {
    ...
    relocate("org.incendo.serverlib", "com.plotsquared.paper.serverlib")
...
tasks {
    withType<Javadoc> {
        ...
        opt.links("https://jd.papermc.io/paper/1.21.7/")
