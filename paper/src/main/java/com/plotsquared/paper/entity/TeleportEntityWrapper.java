 ...
 */
package com.plotsquared.paper.entity;
...
public class TeleportEntityWrapper extends EntityWrapper {
    ...
    public Entity spawn(final World world, final int xOffset, final int zOffset) {
        if (!getEntity().getLocation().getChunk().equals(oldLocation.getChunk())) {
            ...
            PaperSupport.teleportAsync(getEntity(), oldLocation, PlayerTeleportEvent.TeleportCause.PLUGIN)
                    .thenRun(() -> {
                        ...
                        getEntity().removeMetadata("ps-tmp-teleport", PaperPlatform.getPlugin(PaperPlatform.class));
                    });
        }
        return getEntity();
    }
    ...
    public void saveEntity() {
        ...
        this.getEntity().setMetadata(
                "ps-tmp-teleport",
                new FixedMetadataValue(PaperPlatform.getPlugin(PaperPlatform.class), oldLocation)
        );
        final Chunk newChunk = getNewChunk();
        PaperSupport.teleportAsync(getEntity(),
