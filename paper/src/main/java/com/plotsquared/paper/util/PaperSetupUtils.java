...
@Singleton
public class PaperSetupUtils extends SetupUtils {
                ...
                if (plugin.isEnabled()) {
                    ...
                    if (generator != null) {
                        ...
                        if (generator instanceof GeneratorWrapper<?>) {
                            ...
                            wrapped = new PaperPlotGenerator(testWorld, generator, this.plotAreaManager);
                        }
    ...
    public void unload(String worldName, boolean save) {
        TaskManager.runTask(() -> {
            ...
            for (Player player : world.getPlayers()) {
                PaperSupport.teleportAsync(player, location, PlayerTeleportEvent.TeleportCause.PLUGIN);
            }
            if (save) {
    ...
    public String getGenerator(PlotArea plotArea) {
        ...
        if (!(generator instanceof PaperPlotGenerator)) {
            return null;
        }
