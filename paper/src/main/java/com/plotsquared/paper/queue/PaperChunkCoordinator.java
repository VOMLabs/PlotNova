 ...
 * </p>
 **/
public final class PaperChunkCoordinator extends ChunkCoordinator {

    private static final Logger LOGGER = LogManager.getLogger("PlotSquared/" + PaperChunkCoordinator.class.getSimpleName());
    ...
    private final org.bukkit.World paperWorld;
    ...
    private PaperChunkCoordinator(
        ...
        this.plugin = JavaPlugin.getPlugin(PaperPlatform.class);
        this.paperWorld = Bukkit.getWorld(world.getName());
    ...
    private void requestBatch() {
        for (int i = 0; i < this.batchSize && this.requestedChunks.peek() != null; i++) {
            ...
            PaperSupport
                    .getChunkAtAsync(this.paperWorld, chunk.getX(), chunk.getZ(), shouldGen, true)
