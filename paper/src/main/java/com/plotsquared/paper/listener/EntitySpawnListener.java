...
public class EntitySpawnListener implements Listener {
    ...
    public void creatureSpawnEvent(EntitySpawnEvent event) {
        ...
        if (entity instanceof EnderCrystal || type == EntityType.ARMOR_STAND) {
            if (PaperEntityUtil.checkEntity(entity, plot)) {
                event.setCancelled(true);
            }
            return;
        }
    ...
    public void onTeleport(EntityTeleportEvent event) {
        ...
        final Location fromLocLocation = PaperUtil.adapt(fromLocation.getLocation());
        final PlotArea fromArea = fromLocLocation.getPlotArea();
        Location toLocLocation = PaperUtil.adapt(toLocation.getLocation());
