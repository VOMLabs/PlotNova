...
public class PaperListener implements Listener {
    ...
    private static void handleEntityMovement(Cancellable event, org.bukkit.Location from, org.bukkit.Location target) {
        Location toLoc = PaperUtil.adapt(target);
        Location fromLoc = PaperUtil.adapt(from);
    ...
    public void onPreCreatureSpawnEvent(PreCreatureSpawnEvent event) {
        ...
        Location location = PaperUtil.adapt(event.getSpawnLocation());
        PlotArea area = location.getPlotArea();
        if (area == null) {
            return;
        }
    ...
    public void onPreSpawnerSpawnEvent(PreSpawnerSpawnEvent event) {
        if (Settings.Paper_Components.SPAWNER_SPAWN) {
            Location location = PaperUtil.adapt(event.getSpawnerLocation());
            PlotArea area = location.getPlotArea();
    ...
    public void onBlockPlace(BlockPlaceEvent event) {
        ...
        final Location location = PaperUtil.adapt(event.getBlock().getLocation());
        ...
        if (tileEntityCount >= Settings.Chunk_Processor.MAX_TILES) {
            final PlotPlayer<?> plotPlayer = PaperUtil.adapt(event.getPlayer());
    ...
    public void onProjectileLaunch(PlayerLaunchProjectileEvent event) {
        ...
        PlotPlayer<Player> pp = PaperUtil.adapt((Player) shooter);
    ...
    public void onAsyncTabCompletion(final AsyncTabCompleteEvent event) {
        ...
        try {
            final PlotPlayer<?> player = PaperUtil.adapt((Player) event.getSender());
    ...
    public void onBeaconEffect(final BeaconEffectEvent event) {
        ...
        Location beaconLocation = PaperUtil.adapt(block.getLocation());
        ...
        Location playerLocation = PaperUtil.adapt(player.getLocation());
