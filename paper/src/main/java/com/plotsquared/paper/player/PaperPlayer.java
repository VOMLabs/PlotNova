 ...
 */
package com.plotsquared.paper.player;
...
public class PaperPlayer extends PlotPlayer<Player> {
    ...
    public boolean canTeleport(final @NonNull Location location) {
        ...
        final org.bukkit.Location to = PaperUtil.adapt(location);
    ...
    public void teleport(final @NonNull Location location, final @NonNull TeleportCause cause) {
        ...
        final org.bukkit.Location bukkitLocation =
                new org.bukkit.Location(PaperUtil.getWorld(location.getWorldName()), location.getX() + 0.5,
    ...
    public void setCompassTarget(Location location) {
        this.player.setCompassTarget(
                new org.bukkit.Location(PaperUtil.getWorld(location.getWorldName()), location.getX(),
    ...
    public Location getLocationFull() {
        return PaperUtil.adaptComplete(this.player.getLocation());
    }
    ...
    public void playMusic(final @NonNull Location location, final @NonNull ItemType id) {
        ...
        this.player.playSound(
                Sound.sound(BukkitAdapter.adapt(id).getKey(), Sound.Source.MASTER, Float.MAX_VALUE, 1f),
                Sound.Emitter.self()
        );
    }
    ...
    public boolean canSee(final PlotPlayer<?> other) {
        if (other instanceof ConsolePlayer) {
            ...
            return this.player.canSee(((PaperPlayer) other).getPlatformPlayer());
        }
    }
