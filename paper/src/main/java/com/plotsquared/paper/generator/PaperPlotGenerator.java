 ...
 */
package com.plotsquared.paper.generator;

import com.plotsquared.paper.queue.GenChunk;
...
public class PaperPlotGenerator extends ChunkGenerator implements GeneratorWrapper<ChunkGenerator> {

    private static final Logger LOGGER = LogManager.getLogger("PlotSquared/" + PaperPlotGenerator.class.getSimpleName());
    ...
    public PaperPlotGenerator(
        ...
        this.biomeProvider = new PaperPlotBiomeProvider();
    }

    public PaperPlotGenerator(final String world, final ChunkGenerator cg, final @NonNull PlotAreaManager plotAreaManager) {
        if (cg instanceof PaperPlotGenerator) {
            throw new IllegalArgumentException("ChunkGenerator: " + cg
                    .getClass()
                    .getName() + " is already a PaperPlotGenerator!");
        }
        this.plotAreaManager = plotAreaManager;
    ...
    public void augment(PlotArea area) {
        PaperAugmentedGenerator.get(PaperUtil.getWorld(area.getWorldName()));
    }
    ...
    public @NonNull ChunkData generateChunkData(
        ...
        int minY = PlatformWorld.getMinWorldHeight(world);
        int maxY = PlatformWorld.getMaxWorldHeight(world);
        GenChunk result = new GenChunk(minY, maxY);
     ...
     */
    private final class PaperPlotBiomeProvider extends BiomeProvider {
