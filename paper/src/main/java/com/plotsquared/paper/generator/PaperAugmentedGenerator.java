...
public class PaperAugmentedGenerator extends BlockPopulator {

    private static PaperAugmentedGenerator generator;

    public static PaperAugmentedGenerator get(World world) {
        for (BlockPopulator populator : world.getPopulators()) {
            if (populator instanceof PaperAugmentedGenerator) {
                return (PaperAugmentedGenerator) populator;
            }
        }
        if (generator == null) {
            generator = new PaperAugmentedGenerator();
        }
